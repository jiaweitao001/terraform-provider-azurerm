...
func (c ResourcePoolsClient) Delete(ctx context.Context, id ResourcePoolId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "resourcepools.ResourcePoolsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resourcepools.ResourcePoolsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ResourcePoolsClient) preparerForDelete(ctx context.Context, id ResourcePoolId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c ResourcePoolsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
