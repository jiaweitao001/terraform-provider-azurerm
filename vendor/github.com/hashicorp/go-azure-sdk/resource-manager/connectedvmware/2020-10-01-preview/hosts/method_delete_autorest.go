...
func (c HostsClient) Delete(ctx context.Context, id HostId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "hosts.HostsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hosts.HostsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c HostsClient) preparerForDelete(ctx context.Context, id HostId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c HostsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
