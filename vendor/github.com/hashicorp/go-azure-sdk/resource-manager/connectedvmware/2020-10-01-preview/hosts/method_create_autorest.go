...
func (c HostsClient) Create(ctx context.Context, id HostId, input Host) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "hosts.HostsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hosts.HostsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c HostsClient) preparerForCreate(ctx context.Context, id HostId, input Host) (*http.Request, error) {
...
func (c HostsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
