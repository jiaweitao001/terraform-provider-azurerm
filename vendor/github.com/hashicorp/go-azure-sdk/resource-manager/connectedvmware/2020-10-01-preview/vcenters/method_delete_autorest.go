...
func (c VCentersClient) Delete(ctx context.Context, id VCenterId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vcenters.VCentersClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vcenters.VCentersClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VCentersClient) preparerForDelete(ctx context.Context, id VCenterId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c VCentersClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
