...
func (c VCentersClient) Create(ctx context.Context, id VCenterId, input VCenter) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vcenters.VCentersClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vcenters.VCentersClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VCentersClient) preparerForCreate(ctx context.Context, id VCenterId, input VCenter) (*http.Request, error) {
...
func (c VCentersClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
