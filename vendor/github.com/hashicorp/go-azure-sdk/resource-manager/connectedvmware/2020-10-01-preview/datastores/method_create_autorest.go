...
func (c DataStoresClient) Create(ctx context.Context, id DataStoreId, input Datastore) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "datastores.DataStoresClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "datastores.DataStoresClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c DataStoresClient) preparerForCreate(ctx context.Context, id DataStoreId, input Datastore) (*http.Request, error) {
...
func (c DataStoresClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
