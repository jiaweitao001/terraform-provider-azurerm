...
func (c VirtualMachineTemplatesClient) Delete(ctx context.Context, id VirtualMachineTemplateId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinetemplates.VirtualMachineTemplatesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinetemplates.VirtualMachineTemplatesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineTemplatesClient) preparerForDelete(ctx context.Context, id VirtualMachineTemplateId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c VirtualMachineTemplatesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
