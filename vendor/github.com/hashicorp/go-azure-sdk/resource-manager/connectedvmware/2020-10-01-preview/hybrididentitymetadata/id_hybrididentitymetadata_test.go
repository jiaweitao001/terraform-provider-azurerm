...
func TestNewHybridIdentityMetadataID(t *testing.T) {
	id := NewHybridIdentityMetadataID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "metadataValue")
...
func TestFormatHybridIdentityMetadataID(t *testing.T) {
	actual := NewHybridIdentityMetadataID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "metadataValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/hybridIdentityMetadata/metadataValue"
	if actual != expected {
...
func TestParseHybridIdentityMetadataID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/hybridIdentityMetadata/metadataValue",
			Expected: &HybridIdentityMetadataId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/hybridIdentityMetadata/metadataValue/extra",
			Error: true,
		},
	}
