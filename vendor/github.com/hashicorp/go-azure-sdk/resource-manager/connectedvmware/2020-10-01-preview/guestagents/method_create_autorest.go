...
func (c GuestAgentsClient) Create(ctx context.Context, id GuestAgentId, input GuestAgent) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "guestagents.GuestAgentsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "guestagents.GuestAgentsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c GuestAgentsClient) preparerForCreate(ctx context.Context, id GuestAgentId, input GuestAgent) (*http.Request, error) {
...
func (c GuestAgentsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
