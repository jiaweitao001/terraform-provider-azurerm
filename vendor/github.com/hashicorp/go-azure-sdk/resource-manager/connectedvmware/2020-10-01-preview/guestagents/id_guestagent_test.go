...
func TestNewGuestAgentID(t *testing.T) {
	id := NewGuestAgentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "nameValue")
...
func TestFormatGuestAgentID(t *testing.T) {
	actual := NewGuestAgentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "nameValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/guestAgents/nameValue"
	if actual != expected {
...
func TestParseGuestAgentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/guestAgents/nameValue",
			Expected: &GuestAgentId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/virtualMachineValue/guestAgents/nameValue/extra",
			Error: true,
		},
	}
