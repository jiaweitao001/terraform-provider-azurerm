...
func NewExtensionID(subscriptionId string, resourceGroupName string, name string, extensionName string) ExtensionId {
	return ExtensionId{
...
func (id ExtensionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ConnectedVMwarevSphere/virtualMachines/%s/extensions/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.Name, id.ExtensionName)
}
